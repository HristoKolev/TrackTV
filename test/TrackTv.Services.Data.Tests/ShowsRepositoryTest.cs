    ...
    public class ShowsRepositoryTest : BaseRepositoryTest
    {
        ...
        public async Task CountAllAsync_returns_correct_count()
        {
            using (var context = CreateContext())
            {
                ...
                Assert.Equal(10, await repository.CountAllAsync());
            }
        }
        ...
        public async Task CountAllResultsAsync_throws_if_query_is_invalid(string query)
        {
            using (var context = CreateContext())
            {
                ...
                await Assert.ThrowsAsync<InvalidQueryException>(async () => await repository.CountAllResultsAsync(query));
            }
        }
        ...
        public async Task CountByGenreAsync_returns_correct_count()
        {
            using (var context = CreateContext())
            {
                ...
                Assert.Equal(5, await repository.CountByGenreAsync("action"));
            }
        }
        ...
        // ReSharper disable once InconsistentNaming
        public async Task GetShowsByUserIdAsync_returns_correct_count()
        {
            using (var context = CreateContext())
            {
                var list = new List<Show>();
                ...
                var shows = await repository.GetShowsByUserIdAsync(1);
        ...
        public async Task GetShowWithNetworkByIdAsync_returns_show_with_the_network()
        {
            using (var context = CreateContext())
            {
                ...
                var firstShow = await repository.GetShowWithNetworkByIdAsync(1);
        ...
        public async Task GetTopAsync_returns_the_correct_result()
        {
            using (var context = CreateContext())
            {
                ...
                var shows = await repository.GetTopAsync(1, 5);
        ...
        public async Task GetTopByGenreAsync_returns_the_correct_result()
        {
            using (var context = CreateContext())
            {
                ...
                var shows = await repository.GetTopByGenreAsync(dramaGenre.Name, 1, 5);
        ...
        public async Task SearchTopAsync_throws_if_the_query_is_invalid(string query)
        {
            ...
            await Assert.ThrowsAsync<InvalidQueryException>(async () => await repository.SearchTopAsync(query, 1, 5));
        }
        ...
        public async Task SearchTopAsync_returns_correct_shows()
        {
            using (var context = CreateContext())
            {
                ...
                var shows = await repository.SearchTopAsync("old show", 1, 5);
